	...
	<body>
       ...
       <nav class="navbar navbar-default navbar-fixed-top">
		...
		<div class="container-fluid" style="background:#eee; margin-top: 50px; border-radius: 0px;">
			<div class="container">
				<h4> Welcome <b> Manager <i class="glyphicon glyphicon-user"></i> <?php echo $t_name?></b><span class="pull-right" style="line-height:auto; margin-top: px;"><a></a><i class="glyphicon glyphicon-time	"></i> Date: <?php echo $date = date("d/M/y h:i A", time()); ?></span></h4> 
			</div>
		</div>
		<!--
            ====================
                ...
                <div class="col-sm-12" style="text-align:center;">
                    <div class="panel">
                        ...
                        <tr>
							...
							?>
							   <td colspan="3" align="left"  style="background:#444; color:#fff; font-size:20px;">Mr/Ms.<?php echo ucwords($n[1]); ?> ( Money Transfer/Withdrawal Details of <?php echo date('M/Y'); ?> )</td>
							</tr>
							<tr>
							...
							<?php  }?>
							<tr>	
								<td colspan="" class="bg-danger" ><h5 align="center">Given Balance: <?php echo $n['g_amt']; ?> </h5></td>
								<td colspan="" class="bg-success" ><h5 align="center">Remaining Amount: <?php echo $n['amt'];?></h5></td>
