...
<html>		    
	...
	<body>
		...
		<div class="container-fluid" style="background: #f3f3f3;">
            <br/>
            <div class="row">
                <?php if(isset($_GET['i'])){ ?><h3 align="center">Mr/MS. <?php echo $t_name; ?> has been issued <?php echo @$_GET['i']; ?> Rupees.</h3><?php }?>
                <div class="col-sm-4 col-sm-offset-4">
                    <form method="post" action="">
						...
						{//1st starts
							...
							if($r){
							// it refreshs
                                	echo "<script>alert('Mr/Ms $t_name has been given $amt Amount ....!!!')</script>";
