        ...
        <nav class="navbar navbar-default navbar-fixed-top" style="background:">
            <div class="container">
				<div class="navbar-header">
                    <a class="navbar-brand" href="index.php"><strong><i class="glyphicon glyphicon-list-alt"></i> Opra Bank (ATM)</strong></a>
     			</div>
			</div>
		</nav>	
        <!--
                    ...
                    <form method="post" action="">
                        <div class="panel panel-login" style="border-radius:0px; box-shadow:2px 2px 2px 0px;">
                                <div class="panel-heading" id="signin_panel_header">
                                    <p align="center"><img src="../admin/images.png" style="width: 45%;border-radius: 50%;text-align: center;margin: auto;"/> </p>
